...
export default function InterviewSelectionCard({
    ...
    return (
        ...
        >
            {/* Main Card */}
            <div
                className={`relative overflow-hidden rounded-3xl border transition-all duration-500 ${locked
            ...
            >
                ...
                <div className="relative z-10 p-8 h-full flex flex-col">
                    ...
                    <div className="mb-6">
                        <div
                            className={`inline-flex items-center justify-center w-20 h-20 rounded-2xl transition-all duration-500 ${isHovered && !locked ? "scale-110 rotate-6" : ""
                                }`}
                            style={{
                                background: locked
                    ...
                    <div className="flex-1 mb-6">
                        <h3
                            className={`text-3xl font-bold mb-3 ${locked
                        ...
                        <p
                            className={`text-base leading-relaxed ${locked
                    ...
                    <button
                        onClick={onClick}
                        disabled={locked}
                        className={`w-full py-4 px-6 rounded-xl font-semibold text-lg transition-all duration-300 transform ${locked
