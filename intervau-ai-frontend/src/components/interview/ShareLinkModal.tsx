...
export default function ShareLinkModal({
  ...
  const handleEmailShare = () => {
    ...
    const body = encodeURIComponent(
      `You have been invited to an interview for the ${jobPosition} role.\n\nUse the link below to start your interview:\n${fullUrl}\n\nGood luck!`,
    );
  ...
  const handleSlackShare = () => {
    ...
    navigator.clipboard.writeText(slackMessage).then(() => {
      toast.success("Slack message copied. Paste it into your Slack channel.");
    });
  };
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-xl border border-blue-100 dark:border-blue-800">
            <p className="text-sm text-blue-700 dark:text-blue-300">
              <strong>Tip:</strong> Candidates can use this link to start their
              AI-powered interview. The link remains active until you deactivate
              it.
            </p>
          </div>
        </div>
