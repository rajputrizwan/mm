...
export default function VideoTile({
  ...
  return (
    <div
      className={`relative bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl overflow-hidden ${sizeClasses[size]} ${getBorderColor()}`}
    >
      ...
      <div className="relative z-10 w-full h-full flex items-center justify-center">
        {isVideoEnabled ? (
          <div className="text-center">
            <div
              className={`bg-gradient-to-br ${getParticipantColor()} w-20 h-20 rounded-full flex items-center justify-center mb-3 mx-auto`}
            >
