...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed lg:sticky top-0 left-0 h-screen bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-700 transition-all duration-300 z-40 ${sidebarOpen ? "translate-x-0" : "-translate-x-full lg:translate-x-0"
          } ${sidebarOpen ? "w-64" : "lg:w-20"}`}
      >
        <div className="flex flex-col h-full">
          <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700">
            <div
              className={`flex items-center space-x-1 transition-opacity duration-200 ${!sidebarOpen && "lg:opacity-0 lg:w-0 lg:overflow-hidden"
                }`}
            >
          ...
          <div className="flex-1 overflow-y-auto py-4">
            <div
              className={`px-3 mb-2 transition-opacity duration-200 ${!sidebarOpen && "lg:opacity-0 lg:h-0 lg:overflow-hidden"
                }`}
            >
              ...
              {links.map((link) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full flex items-center ${sidebarOpen ? "space-x-3" : "lg:justify-center"
                  ...
                  >
                    ...
                    />
                    <span
                      className={`font-medium transition-opacity duration-200 whitespace-nowrap ${!sidebarOpen && "lg:opacity-0 lg:w-0 lg:overflow-hidden"
                        }`}
                    >
                      {link.label}
                    </span>
          ...
          <div className="border-t border-gray-200 dark:border-gray-700 p-4">
            <div
              className={`flex items-center mb-3 transition-all duration-200 ${sidebarOpen ? "space-x-3" : "lg:justify-center"
                }`}
            >
              ...
              <div
                className={`flex-1 min-w-0 transition-opacity duration-200 ${!sidebarOpen && "lg:opacity-0 lg:w-0 lg:overflow-hidden"
                  }`}
              >
