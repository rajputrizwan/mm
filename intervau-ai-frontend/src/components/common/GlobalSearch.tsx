                                        ...
                                        {categoryResults.map((result) => {
                                            ...
                                            return (
                                                <button
                                                    ...
                                                    className={`w-full px-4 py-3 flex items-start space-x-3 hover:bg-blue-50 dark:hover:bg-gray-700/50 transition-colors ${isSelected
                                                ...
                                                >
                                                    {/* Icon */}
                                                    <div
                                                        className={`flex-shrink-0 w-10 h-10 rounded-lg flex items-center justify-center ${category === 'Actions'
