    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
      <div className="max-w-[1800px] mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="mb-6">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-2 bg-red-100 dark:bg-red-900/30 text-red-600 dark:text-red-400 px-4 py-2 rounded-lg font-medium">
                <div className="w-3 h-3 bg-red-600 dark:bg-red-500 rounded-full animate-pulse" />
                <span>Recording</span>
              </div>
              <div className="flex items-center space-x-2 bg-white dark:bg-gray-800 px-4 py-2 rounded-lg border border-gray-200 dark:border-gray-700">
                ...
                <span className="font-medium text-gray-900 dark:text-white">{formatTime(elapsedTime)}</span>
                <span className="text-gray-400 dark:text-gray-500">/</span>
                <span className="text-gray-600 dark:text-gray-400">30:00</span>
              </div>
              {isSpeaking && (
                <div className="flex items-center space-x-2 bg-green-100 dark:bg-green-900/30 text-green-600 dark:text-green-400 px-4 py-2 rounded-lg font-medium">
                  <div className="flex space-x-1">
                    <div className="w-1 h-4 bg-green-600 dark:bg-green-500 rounded-full animate-pulse" />
                    <div className="w-1 h-4 bg-green-600 dark:bg-green-500 rounded-full animate-pulse" style={{ animationDelay: '0.1s' }} />
                    <div className="w-1 h-4 bg-green-600 dark:bg-green-500 rounded-full animate-pulse" style={{ animationDelay: '0.2s' }} />
                  </div>
                  <span>Speaking</span>
                </div>
              )}
          ...
          <div className="w-full bg-gray-200 dark:bg-gray-800 rounded-full h-3 shadow-inner">
            <div
              className="bg-gradient-to-r from-blue-600 to-cyan-600 dark:from-blue-500 dark:to-cyan-500 h-3 rounded-full transition-all duration-500 shadow-lg"
              style={{ width: `${progress}%` }}
            />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          <div className="lg:col-span-2 xl:col-span-3 space-y-6">
            ...
            {currentQuestionIndex < questions.length - 1 && (
              <button
                onClick={handleNextQuestion}
                className="w-full flex items-center justify-center space-x-2 px-6 py-4 bg-gradient-to-r from-blue-600 to-cyan-600 dark:from-blue-500 dark:to-cyan-500 text-white rounded-xl font-semibold hover:shadow-xl transition-all"
              >
                <span>Next Question</span>
                <ChevronRight className="w-5 h-5" />
              </button>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 border border-gray-100 dark:border-gray-700">
              <div className="flex items-center space-x-2 mb-4">
                ...
                <h3 className="font-semibold text-gray-900 dark:text-white">Speaking Patterns</h3>
              </div>
              <div className="grid md:grid-cols-4 gap-4">
                <div className="text-center p-4 bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 rounded-lg">
                  <p className="text-2xl font-bold text-blue-600 dark:text-blue-400">{speakingPatterns.fillerWords}</p>
                  <p className="text-xs text-gray-600 dark:text-gray-300 mt-1">Filler Words</p>
                </div>
                <div className="text-center p-4 bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-lg">
                  <p className="text-2xl font-bold text-green-600 dark:text-green-400">{speakingPatterns.avgResponseTime}</p>
                  <p className="text-xs text-gray-600 dark:text-gray-300 mt-1">Avg Response</p>
                </div>
                <div className="text-center p-4 bg-gradient-to-br from-orange-50 to-amber-50 dark:from-orange-900/20 dark:to-amber-900/20 rounded-lg">
                  <p className="text-2xl font-bold text-orange-600 dark:text-orange-400">{speakingPatterns.totalWords}</p>
                  <p className="text-xs text-gray-600 dark:text-gray-300 mt-1">Total Words</p>
                </div>
                <div className="text-center p-4 bg-gradient-to-br from-cyan-50 to-blue-50 dark:from-cyan-900/20 dark:to-blue-900/20 rounded-lg">
                  <p className="text-2xl font-bold text-cyan-600 dark:text-cyan-400">{speakingPatterns.avgWordsPerMinute}</p>
                  <p className="text-xs text-gray-600 dark:text-gray-300 mt-1">Words/Minute</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-4 border border-gray-100 dark:border-gray-700">
              <div className="flex items-center space-x-2 mb-3">
                ...
                <h4 className="text-sm font-semibold text-gray-900 dark:text-white">Real-time Tips</h4>
              </div>
              <div className="space-y-2">
                <div className="p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-100 dark:border-blue-800">
                  <p className="text-xs text-gray-700 dark:text-gray-300">Maintain eye contact with the camera</p>
                </div>
                <div className="p-3 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-100 dark:border-green-800">
                  <p className="text-xs text-gray-700 dark:text-gray-300">Great use of technical examples!</p>
                </div>
                <div className="p-3 bg-orange-50 dark:bg-orange-900/20 rounded-lg border border-orange-100 dark:border-orange-800">
                  <p className="text-xs text-gray-700 dark:text-gray-300">Try to reduce filler words</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-4 border border-gray-100 dark:border-gray-700">
              <div className="flex items-center space-x-2 mb-3">
                ...
                <h4 className="text-sm font-semibold text-gray-900 dark:text-white">Question List</h4>
              </div>
              <div className="space-y-2">
                {questions.map((q, idx) => (
                  <div
                  ...
                  >
                    <div className="flex items-center justify-between mb-1">
                      <span className="text-xs font-semibold text-gray-900 dark:text-white">Q{idx + 1}</span>
                      <span className="text-xs bg-white dark:bg-gray-800 px-2 py-0.5 rounded text-gray-600 dark:text-gray-400">
                        {q.category}
                      </span>
                    </div>
                    <p className="text-xs text-gray-700 dark:text-gray-300 line-clamp-2">{q.text}</p>
                  </div>
                ))}
              </div>
            </div>
