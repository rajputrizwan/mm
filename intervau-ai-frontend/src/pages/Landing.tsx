  ...
  const renderHomeSection = () => (
    <>
      <div id="home" className="text-center mb-32 pt-12 scroll-mt-20">
        ...
        <h1 className="text-5xl md:text-7xl font-bold text-gray-900 dark:text-white mb-8 leading-[1.15] md:leading-[1.1]">
          Master Your Interviews with
          <span className="block mt-3 pb-1 bg-gradient-to-r from-blue-600 via-cyan-600 to-blue-600 bg-clip-text text-transparent">
