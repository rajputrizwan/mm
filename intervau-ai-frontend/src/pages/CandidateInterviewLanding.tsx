...
import { saveSession, hasActiveSession, loadSession } from '../components/interview/InterviewSessionStorage';
...
export default function CandidateInterviewLanding() {
    ...
    useEffect(() => {
        const fetchInterview = async () => {
            ...
            try {
                const response = await fetch(`${import.meta.env.VITE_API_URL || 'http://localhost:5000'}/api/interview-session/public/${uuid}`);
                ...
                if (hasActiveSession(uuid)) {
                    ...
                    if (existingSession) {
                        ...
                        toast.success('Found your previous session!');
                    }
                }
            } catch (err: any) {
    ...
    const handleStartInterview = async () => {
        ...
        setStarting(true);
        try {
            const response = await fetch(`${import.meta.env.VITE_API_URL || 'http://localhost:5000'}/api/interview-session/start`, {
                method: 'POST',
        ...
        return (
            <div className="min-h-screen bg-slate-950 flex items-center justify-center px-4">
                <div className="text-center max-w-md">
                    ...
                    <h1 className="text-2xl font-bold text-white mb-3">Interview Not Found</h1>
            ...
            <div className="relative max-w-4xl mx-auto px-4 py-12">
                ...
                <div className="text-center mb-12">
                    <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-cyan-500/10 to-blue-500/10 border border-cyan-500/20 rounded-full mb-6">
                        ...
                        <span className="text-sm font-medium text-cyan-400">AI-Powered Interview</span>
                    </div>
                    <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
                        Welcome to Your Interview
                    </h1>
                    <p className="text-lg text-slate-400 max-w-2xl mx-auto">
                        Get ready for an AI-powered interview experience. Make sure your camera and microphone are working.
                    </p>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl border border-slate-700/50 p-4">
                                ...
                                <p className="text-2xl font-bold text-white">{interview.duration} min</p>
                            </div>
                            <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl border border-slate-700/50 p-4">
                                <div className="flex items-center gap-3 mb-2">
                                ...
                                <p className="text-2xl font-bold text-white">{interview.questionCount}</p>
                            </div>
                        </div>
                        ...
                        <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl border border-slate-700/50 p-6">
                            ...
                            <ul className="space-y-3">
                                {[
                                    'AI interviewer will guide you through questions',
                                    'Speak naturally - the AI understands you',
                                    interview.aiSettings.autoScore && 'Real-time scoring of your responses',
                                    interview.aiSettings.enableAiFeedback && 'Detailed feedback after completion',
                    ...
                    <div className="space-y-6">
                        ...
                        {showSystemCheck ? (
                            <SystemCheckModule
                                onCheckComplete={(passed) => {
                                    ...
                                    if (passed) {
                                        toast.success('System check passed! You can start the interview.');
                                    }
                                }}
                            />
                        ) : (
                            ...
                            >
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-4">
                                        <div className={`w-12 h-12 rounded-xl flex items-center justify-center ${systemCheckPassed
                                                ? 'bg-green-500/20'
                                                : 'bg-slate-700/50 group-hover:bg-cyan-500/20'
                                            }`}>
                                            <Shield className={`w-6 h-6 ${systemCheckPassed ? 'text-green-500' : 'text-slate-400 group-hover:text-cyan-400'
                                                }`} />
                                        </div>
                                        <div>
                        ...
                        <button
                            ...
                            disabled={!candidateName || !candidateEmail || !systemCheckPassed || starting}
                            className={`w-full py-4 px-6 rounded-xl font-semibold text-lg transition-all flex items-center justify-center gap-3 ${candidateName && candidateEmail && systemCheckPassed && !starting
                        ...
                        <p className="text-xs text-slate-500 text-center">
                            By starting, you agree to have your interview recorded for evaluation purposes.
