    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-cyan-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-16">
          <h1 className="text-5xl font-bold text-gray-900 dark:text-white mb-4">About Intervau.AI</h1>
        ...
        <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-lg p-12 border border-gray-100 dark:border-gray-800 mb-16">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <div className="bg-gradient-to-br from-blue-100 to-blue-50 dark:from-blue-900 dark:to-blue-800 rounded-2xl border border-blue-200 dark:border-blue-700 p-8">
            <p className="text-4xl font-bold text-blue-600 dark:text-blue-300 mb-2">50K+</p>
            <p className="text-gray-700 dark:text-gray-300 font-semibold">Interviews Completed</p>
          </div>
          <div className="bg-gradient-to-br from-green-100 to-green-50 dark:from-green-900 dark:to-green-800 rounded-2xl border border-green-200 dark:border-green-700 p-8">
            <p className="text-4xl font-bold text-green-600 dark:text-green-300 mb-2">92%</p>
            <p className="text-gray-700 dark:text-gray-300 font-semibold">Success Rate</p>
          </div>
          <div className="bg-gradient-to-br from-cyan-100 to-cyan-50 dark:from-cyan-900 dark:to-cyan-800 rounded-2xl border border-cyan-200 dark:border-cyan-700 p-8">
            <p className="text-4xl font-bold text-cyan-600 dark:text-cyan-300 mb-2">150+</p>
            <p className="text-gray-700 dark:text-gray-300 font-semibold">Companies Using Intervau</p>
          </div>
        </div>

        <div className="mb-16">
          <h2 className="text-4xl font-bold text-gray-900 dark:text-white text-center mb-12">Meet Our Team</h2>
          <div className="grid md:grid-cols-4 gap-8">
            {team.map((member, idx) => (
              <div key={idx} className="bg-white dark:bg-gray-900 rounded-2xl shadow-lg p-6 border border-gray-100 dark:border-gray-800 text-center hover:shadow-xl transition-all">
