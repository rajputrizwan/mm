...
export default function InterviewReport() {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      setAnimatedAI(reportData.candidate.aiAnalysisScore);
      setAnimatedResume(reportData.candidate.resumeMatchScore);
    }, 300);
              ...
              <div className="flex items-start justify-between mb-6">
                <div>
                  ...
                  <div className="flex items-center space-x-4 mt-3 text-sm text-gray-600 dark:text-gray-400">
                    ...
                    <span>•</span>
                    <span>{reportData.candidate.date}</span>
                    <span>•</span>
              ...
              <div className="space-y-4 p-6 bg-gradient-to-r from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 rounded-xl border border-blue-100 dark:border-blue-800">
                <div>
                  ...
                  <div className="w-full bg-blue-200/30 dark:bg-blue-900/30 rounded-full h-3 overflow-hidden">
                    <div
                      className="bg-gradient-to-r from-blue-500 to-blue-600 dark:from-blue-400 dark:to-blue-500 h-3 rounded-full transition-all duration-1000 ease-out shadow-sm"
                      style={{ width: `${animatedAI}%` }}
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="w-full bg-cyan-200/30 dark:bg-cyan-900/30 rounded-full h-3 overflow-hidden">
                    <div
                      className="bg-gradient-to-r from-cyan-500 to-cyan-600 dark:from-cyan-400 dark:to-cyan-500 h-3 rounded-full transition-all duration-1000 ease-out shadow-sm"
                      style={{ width: `${animatedResume}%` }}
                    />
                  </div>
                </div>
              </div>
