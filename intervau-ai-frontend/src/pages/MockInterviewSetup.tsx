...
export default function MockInterviewSetup() {
  ...
  const [effectiveJobDescription, setEffectiveJobDescription] =
    useState<string>("");
  ...
  const handleGenerateQuestions = async () => {
    ...
    setGenerating(true);
    try {
      const userProvidedDescription = config.jobDescription.trim();
      ...
      if (response.success && response.data) {
        ...
        setEffectiveJobDescription(userProvidedDescription);
