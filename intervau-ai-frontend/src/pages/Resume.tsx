...
export default function Resume() {
  ...
  const extractedData = {
    ...
    title: "Senior Full Stack Developer",
    summary:
      "Experienced software engineer with 6+ years of expertise in building scalable web applications. Proven track record of leading development teams and delivering high-quality solutions using modern technologies.",
    skills: [
      { name: "React", level: 90, category: "Frontend" },
      { name: "Node.js", level: 85, category: "Backend" },
      { name: "TypeScript", level: 88, category: "Languages" },
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center mb-12">
            <div className="inline-flex items-center space-x-2 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 px-4 py-2 rounded-full text-sm font-medium mb-6">
              <Sparkles className="w-4 h-4" />
              <span>{t("resume.aiPoweredAnalysis")}</span>
            </div>
            <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">
              {t("resume.uploadYourResume")}
            </h1>
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              {t("resume.aiWillExtract")}
            </p>
          </div>

          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-12 border-2 border-dashed border-gray-300 dark:border-gray-600 hover:border-blue-400 dark:hover:border-blue-500 transition-colors">
            <label htmlFor="resume-upload" className="cursor-pointer block">
              <div className="text-center">
                ...
                <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">
                  {uploading
                    ? t("resume.analyzingResume")
                    : t("resume.dropYourResume")}
                </h3>
                <p className="text-gray-600 dark:text-gray-300 mb-6">
                  {t("resume.orClickToBrowse")}
                </p>
            ...
            <div className="text-center">
              <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg border border-gray-100 dark:border-gray-700">
                ...
                <h4 className="font-semibold text-gray-900 dark:text-white mb-2">
                  {t("resume.skillExtraction")}
                </h4>
                <p className="text-sm text-gray-600 dark:text-gray-300">
                  {t("resume.identifySkills")}
                </p>
              </div>
            </div>
            <div className="text-center">
              <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg border border-gray-100 dark:border-gray-700">
                ...
                <h4 className="font-semibold text-gray-900 dark:text-white mb-2">
                  {t("resume.gapAnalysis")}
                </h4>
                <p className="text-sm text-gray-600 dark:text-gray-300">
                  {t("resume.discoverAreas")}
                </p>
              </div>
            </div>
            <div className="text-center">
              <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg border border-gray-100 dark:border-gray-700">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300">
                  {t("resume.personalizedQuestions")}
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8 flex items-center justify-between">
          <div>
            <div className="inline-flex items-center space-x-2 bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400 px-3 py-1 rounded-full text-sm font-medium mb-3">
              <CheckCircle className="w-4 h-4" />
              <span>{t("resume.analysisComplete")}</span>
            </div>
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white">
              {t("resume.resumeAnalysis")}
            </h1>
          </div>
          <button
            onClick={() => setUploaded(false)}
        ...
        <div className="grid lg:grid-cols-3 gap-6 mb-6">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border border-gray-100 dark:border-gray-700">
            ...
            <h3 className="text-sm font-medium text-gray-600 dark:text-gray-300 mb-1">
              {t("resume.skillsExtracted")}
            </h3>
            <p className="text-lg font-semibold text-gray-900 dark:text-white">
              {extractedData.skills.length} Skills
            </p>
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
              {t("resume.acrossCategories")}
            </p>
          </div>
